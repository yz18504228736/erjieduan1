...
<head>
    ...
    <style type="text/css">
        ...
        #Head_1 {
            background: url("${ctx}/static/admin/images/img/top_head1_bg.gif") repeat-x scroll 0 0 transparent;
            height: 64px;
            margin: 0 auto;
            width: 100%;
        }
        ...
        #Head_2 {
            background: url("${ctx}/static/admin/images/img/top_head2_bg.gif") repeat-x scroll 0 0 transparent;
...
<div id="Head_1">
    ...
    <div id="Head_1_UserWelcome">
        <img border="0" width="13" height="14" src="${ctx}/static/admin/images/user.gif" />
        您好，<b>${sessionScope.admin.nick_name}</b>
    </div>
    <!-- 一些链接按钮 -->
    <div id="Head_1_FunctionButton">
        <a target="right" href="javascript:void(0)">
            <img width="78" height="20" src="${ctx}/static/admin/images/help2.gif" />
        </a>
        <a target="_parent" href="${ctx}/adminController?op=logout">
            <img width="78" height="20" alt="退出系统" src="${ctx}/static/admin/images/logout.gif" />
        </a>
    </div>
</div>
<!-- 下部 -->
<div id="Head_2">
    ...
    <div class="Head2_FunctionList" style="float:left">
        <a href="javascript: window.parent.right.history.back();">
            <img src="${ctx}/static/admin/images/Header_back.gif" width="24" height="24" style="margin-top: -8px;"/>
            <b>后退</b>
        </a>
        <a href="javascript: window.parent.right.history.forward();">
            <img src="${ctx}/static/admin/images/Header_forward.gif" width="24" height="24" style="margin-top: -8px;"/>
            <b>前进</b>
        </a>
    </div>
    ...
    <div id="Head2_FunctionList">
        ...
        <a href="javascript: window.parent.right.history.go(0);">
            <img src="${ctx}/static/admin/images/Header_refresh.gif" width="24" height="24" style="margin-top: -8px;"/>
            <b>刷新(IE、Chrome)</b>
        </a>
